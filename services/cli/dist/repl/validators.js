...
exports.validateKBParams = validateKBParams;
exports.validateTimerParams = validateTimerParams;
exports.validateMCPParams = validateMCPParams;
/**
 * 验证知识库参数
 */
function validateKBParams(params) {
    const errors = [];
 ...
 * 验证定时任务参数
 */
function validateTimerParams(params) {
    const errors = [];
 ...
 * 验证 MCP 参数
 */
function validateMCPParams(params) {
    const errors = [];
